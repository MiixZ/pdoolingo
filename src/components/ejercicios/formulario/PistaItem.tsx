...
interface Props {
  defaultTipoCoste?: string;
  defaultCoste?: number;
}

const PistaItem: React.FC<Props> = ({ defaultTipoCoste, defaultCoste }) => {
  return (
    <>
      <header>
        <h2 className="text-2xl font-bold text-wrap text-white mt-10 truncate">
          Agrega la lógica de las pistas
        </h2>
      </header>
      ...
      <div className="flex flex-col lg:flex-row items-baseline text-black justify-between gap-5 text-xl rounded-xl transition-all w-full">
        <select
          ...
          id="tipo"
          name="tipo_coste_pista"
          defaultValue={defaultTipoCoste}
        >
